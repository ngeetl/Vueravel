<template>
    <div class="team container mx-auto py-28 xl:px-72 min-h-fit flex-col justify-center items-center">
        <div ref="event1" class="opacity-0 tag-cloud flex justify-end relative font-light mr-10">
